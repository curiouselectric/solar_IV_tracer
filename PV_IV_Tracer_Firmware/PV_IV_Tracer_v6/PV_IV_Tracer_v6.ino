/*
 ...
 Voltage is read using a potential divider (680K // 47k).
 Current is read using an AD211 high side current monitor with a shunt resistor.
 The internal 2.56V reference voltage is used. This is calibrated (as it can range from 2.2 to 2.7V)
...
//       // A reading of 1023 = Vref
//       // The calibration factor is the reading when 1V is applied
//       // Voltage measured by a potential divider 680k and 47k
...
//       currentSensor = (currentSensor*5000)/1024;
       ...
       // Running through 160 values so each step is 255/160 = 1.59
       // Increase the PWM to the FET to increase the current
       analogWrite(dump1, ((255/160)*(dataPointCounter/4)));    // This outputs the correct PWM
